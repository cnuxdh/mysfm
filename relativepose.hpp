...
public:
	...
	virtual int EstimatePose( vector<Point2DDouble>& lPts, vector<Point2DDouble>& rPts, 
		CameraPara& cam1, CameraPara& cam2, vector<int>& inliers ){return 0;}
...
public:
	...
	int EstimatePose( vector<Point2DDouble>& lPts, vector<Point2DDouble>& rPts, 
